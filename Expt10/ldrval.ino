...
*/
        ...
        // You have to download DHT11  library
...
//     int ldrval = analogRead(ldr_input);
      int ldrval=5;
      Serial.println("LDRVAL="+String(ldrval)+" *ohm");
      virtuino.vMemoryWrite(0,ldrval);    // write temperature 1 to virtual pin V0. On Virtuino panel add a value display or an analog instrument to pin V0
