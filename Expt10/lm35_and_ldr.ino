...
void readTemperatures(){
   Serial.println("Read sensors' values...");
      ...
      int raw=analogRead(lmPin);
      //float percent = (raw*5.0)/1023.0;
      float volts=100*(raw/1023.0)*5.0;
      if (isnan(volts)) {
        Serial.println("Failed to read from DHT");
          ...
          virtuino.vMemoryWrite(0,volts);    // write temperature 1 to virtual pin V0. On Virtuino panel add a value display or an analog instrument to pin V0
